...
*𝐸𝑛𝑣𝑖𝑎𝑛𝑑𝑜.. 𝑎𝑔𝑢𝑎𝑟𝑑𝑒 𝑢𝑛 𝑚𝑜𝑚𝑒𝑛𝑡𝑜 𝑎 𝑞𝑢𝑒 𝑠𝑒 𝑒𝑛𝑣𝑖𝑒 𝑠𝑢 ${additionalText}*`, 
contextInfo: {
externalAdReply: {
...
await await conn.sendMessage(m.chat, { video: { url: dl_url }, fileName: `${ttl}.mp4`, mimetype: 'video/mp4', caption: `*✅ 𝑨𝒒𝒖𝒊 𝒆𝒔𝒕𝒂 𝒔𝒖 𝒗𝒊𝒅𝒆𝒐*\n*🌺 𝑻𝒊𝒕𝒖𝒍𝒐/𝑵𝒐𝒎𝒃𝒓𝒆: ${ttl}`, thumbnail: await fetch(yt.thumbnail) }, { quoted: m })
} catch {   
try {  
...
await conn.sendMessage(m.chat, { video: { url: n2 }, fileName: `${n}.mp4`, mimetype: 'video/mp4', caption: `✅ 𝑨𝒒𝒖𝒊 𝒆𝒔𝒕𝒂 𝒔𝒖 𝒗𝒊𝒅𝒆𝒐*\n*🌺 𝑻𝒊𝒕𝒖𝒍𝒐/𝑵𝒐𝒎𝒃𝒓𝒆: ${n}`, thumbnail: await fetch(n4) }, { quoted: m })
} catch {
}}}}} catch {
}}

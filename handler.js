...
—◉ *Iɴᴛᴇɴᴛᴀ Rᴇᴛɪʀᴀʀ Eʟ Bᴀɴᴇᴏ Aǫᴜɪ:* Wa.me/595976126756
            `.trim();
              m.reply(messageText);
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        ...
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;🌸The-MieBot-MDV2🌸;;;\nFN:🌸The-MieBot-MDV2🌸\nORG:🌸TheMieBot-MDV2🌸\nTITLE:\nitem1.TEL;waid=595987138033:+595 987 138033\nitem1.X-ABLabel:🌸The-MieBot-MDV2🌸\nX-WA-BIZ-DESCRIPTION:[❗] ᴄᴏɴᴛᴀᴄᴛᴀ ᴀ ᴇsᴛᴇ ɴᴜᴍ ᴘᴀʀᴀ ᴄᴏsᴀs ɪᴍᴘᴏʀᴛᴀɴᴛᴇs.\nX-WA-BIZ-NAME:🌸The-MieBot-MDV2🌸\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: '🌸The-MieBot-MDV2🌸', contacts: [{vcard}]}}, {quoted: callmsg});
...
let date = d.toLocaleDateString('es', { day: 'numeric', month: 'long', year: 'numeric' })
  ...
  *⏰ 𝑯𝒐𝒓𝒂:* ${time}
  *🗓️ 𝑭𝒆𝒄𝒉𝒂:* ${date}
  *⏱️ 𝑬𝒏𝒗𝒊𝒂𝒏𝒅𝒐 𝒆𝒍 𝒎𝒆𝒏𝒔𝒂𝒋𝒆 𝒆𝒍𝒊𝒎𝒊𝒏𝒂𝒅𝒐...*
...
global.dfail = (type, m, conn) => {
  const msg = {
    ...
    unreg: '*¡𝐏𝐚𝐫𝐚 𝐂𝐨𝐧𝐭𝐢𝐧𝐮𝐚𝐫 𝐂𝐨𝐧 𝐄𝐬𝐭𝐚 𝐅𝐮𝐧𝐜𝐢𝐨𝐧 𝐄𝐬 𝐍𝐞𝐜𝐞𝐬𝐚𝐫𝐢𝐨 𝐑𝐞𝐠𝐢𝐬𝐭𝐫𝐚𝐫𝐬𝐞!*\n\n!verificar nombre.edad\n\n*Uso correcto* : .verificar Sakura-OFC.20',
    restrict: '*🌸 𝘊𝘰𝘮𝘢𝘯𝘥𝘰 𝘙𝘦𝘴𝘵𝘳𝘪𝘯𝘨𝘪𝘥𝘰 𝘗𝘰𝘳 𝘋𝘦𝘴𝘪𝘤𝘪𝘰́𝘯 𝘋𝘦𝘭 𝘗𝘳𝘰𝘱𝘪𝘦𝘵𝘢𝘳𝘪𝘰 𝘋𝘦𝘭 𝘉𝘰𝘵.*',
    }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '𝑯𝒐𝒍𝒂, 𝒒𝒖𝒆 𝒕𝒂𝒍 :D', body: '𝑩𝒐𝒏𝒊𝒕𝒂 𝒋𝒐𝒓𝒏𝒂𝒅𝒂', thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/JiV3MmlAynCEMdDkDVQoLu'}}}}, aa);
